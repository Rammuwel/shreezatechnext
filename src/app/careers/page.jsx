    ...
    <PageTemplate title="Careers">
        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-5xl font-light text-black leading-tight mb-6">
              Indulge and Grow <br/> With Novac Family
            </h2>
      ...
      <section className="py-24 bg-[#0b0c10]">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6">
            <h2 className="text-3xl md:text-4xl text-white font-light">Open positions</h2>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row-reverse items-center gap-16">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-light text-black leading-tight mb-8">
              Our Commitment to <span className="text-blue-600">Diversity And Inclusion</span>
            </h2>
            <p className="text-[17px] text-gray-600 font-light leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-light text-black mb-4">Women in Technology.</h3>
            <p className="text-[17px] text-gray-600 font-light leading-relaxed">
        ...
        <div className="max-w-[1300px] mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row gap-10 mb-16">
             <div className="md:w-1/3">
               <h2 className="text-3xl md:text-5xl font-light text-blue-500 leading-tight">
                 Fun@Work.
               </h2>
             </div>
