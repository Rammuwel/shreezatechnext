    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-end pb-20 overflow-hidden">
        ...
        <div className="max-w-[900px] mx-auto px-6 relative z-10 w-full">
          ...
          <h1 className="text-3xl md:text-4xl md:text-6xl font-bold text-white mb-4 leading-tight">
            {project.title}
          </h1>
        </div>
      </section>
      ...
      {/* 3. CTA Section */}
      <section className="py-10 md:py-20 lg:py-24 bg-[#040026] relative overflow-hidden text-center">
