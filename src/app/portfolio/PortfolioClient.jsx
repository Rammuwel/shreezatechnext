...
export default function PortfolioClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 bg-[#040026] overflow-hidden">
        ...
        <div className="max-w-[1300px] mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
      ...
      <section className="py-4 md:py-8 bg-white border-b border-gray-200 sticky top-[72px] z-30 shadow-sm">
        <div className="max-w-[1300px] mx-auto px-6">
          <div className="flex overflow-x-auto md:flex-wrap md:justify-center gap-2 md:gap-4 pb-2 md:pb-0 snap-x [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {filters.map((filter) => (
              <button
                key={filter}
                onClick={() => setActiveFilter(filter)}
                className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 whitespace-nowrap flex-shrink-0 snap-start ${activeFilter === filter
                    ? 'bg-[#040026] text-white shadow-md md:transform md:scale-105'
      ...
      {/* 4. Strong Footer CTA */}
      <section className="py-10 md:py-20 lg:py-24 bg-[#040026] relative overflow-hidden">
        {/* Background elements */}
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <h2 className="text-3xl md:text-4xl md:text-5xl font-bold text-white mb-6">
