...
export default function UXUIDesignPage() {
  const config = {
      ...
      slides: [
        {
          ...
          primaryButton: { text: "Start Design Project", href: "/contact-us" }
        },
        {
          image: "/images/discover-tech-1.jpg",
    ...
    philosophy: {
      ...
      image1: "/images/about-diversity.jpg",
    ...
    security: {
      ...
      button: { text: "Audit Your Accessibility", href: "/contact-us" },
      cards: [
        {
        ...
        {
          icon: <MousePointerClick className="w-12 h-12 text-[#ffb916]" />,
        ...
        {
          icon: <Smartphone className="w-12 h-12 text-[#ffb916]" />,
    ...
    cta: {
      ...
      button1: { text: "Start Design Consultation", href: "/contact-us" },
      button2: { text: "View Design Portfolio", href: "/contact-us" }
    }
  };
