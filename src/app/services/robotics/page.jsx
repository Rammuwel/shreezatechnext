...
export default function RoboticsPage() {
  const config = {
      ...
      slides: [
        {
          ...
          primaryButton: { text: "Automate Operations", href: "/contact" }
        },
        {
    ...
    philosophy: {
      ...
      image1: "https://images.unsplash.com/photo-1563207153-f403bf289096?auto=format&fit=crop&q=80",
    ...
    security: {
      ...
      button: { text: "Learn About Our Safety Standards", href: "/contact" },
      cards: [
        {
        ...
        {
          icon: <Power className="w-12 h-12 text-[#D4AF37]" />,
    ...
    cta: {
      ...
      button1: { text: "Schedule Engineering Consultation", href: "/contact" },
      button2: { text: "View Industrial Implementations", href: "/contact" }
    }
  };
