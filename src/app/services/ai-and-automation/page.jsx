...
export default function AIAutomationPage() {
  const config = {
    ...
    hero: {
      slides: [
        ...
        },
        {
          ...
          secondaryButton: { text: "Automate Your Business", href: "/contact" }
        }
      ]
    },
    stats: [
    ...
    philosophy: {
      ...
      image1: "https://images.unsplash.com/photo-1555255707-c07966088b7b?auto=format&fit=crop&q=80",
    ...
    security: {
      ...
      button: { text: "Learn About Our AI Security", href: "/contact" },
      cards: [
        {
        ...
        {
          icon: <Network className="w-12 h-12 text-[#D4AF37]" />,
        ...
        {
          icon: <Cpu className="w-12 h-12 text-[#D4AF37]" />,
    ...
    cta: {
      ...
      button1: { text: "Schedule AI Consultation", href: "/contact" },
      button2: { text: "View Success Stories", href: "/contact" }
    }
  };
