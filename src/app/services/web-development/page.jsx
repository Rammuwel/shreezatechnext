...
export default function WebDevelopmentPage() {
  const config = {
      ...
      slides: [
        {
          ...
          description: "We engineer highly scalable, secure, and blazing-fast web platforms that transform complex business logic into seamless, high-converting user experiences.",
          primaryButton: { text: "Initiate Project", href: "/contact" }
        },
        {
    ...
    philosophy: {
      ...
      image1: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80",
    ...
    security: {
      ...
      button: { text: "Request Security Audit", href: "/contact" },
      cards: [
        {
    ...
    cta: {
      ...
      button2: { text: "View Our Case Studies", href: "/contact" }
    }
  };
