...
export default function RealEstateSolutionPage() {
  const config = {
    ...
    hero: {
      ...
      primaryButton: { text: "Manage Your Portfolio", href: "/contact-us" },
      stats: [
    ...
    cta: {
      ...
      button1: { text: "Schedule PropTech Consultation", href: "/contact-us" },
      button2: { text: "View API Integrations", href: "/contact-us" }
    }
  };
