...
export default function ManufacturingSolutionPage() {
  const config = {
    ...
    hero: {
      ...
      primaryButton: { text: "Schedule Factory Audit", href: "/contact-us" },
      stats: [
    ...
    cta: {
      ...
      button1: { text: "Schedule Factory Audit", href: "/contact-us" },
      button2: { text: "View Industry 4.0 Architecture", href: "/contact-us" }
    }
  };
