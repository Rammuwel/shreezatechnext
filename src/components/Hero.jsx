        ...
        <SwiperSlide className="w-full h-full relative flex items-center">
          ...
          <div className="max-w-[1300px] mx-auto px-6 h-full flex flex-col justify-center relative z-10 pt-24 pb-24 md:pt-32 md:pb-48 w-full">
            <div className="max-w-4xl">
              <h1 className="text-[28px] md:text-[56px] leading-[36px] md:leading-[64px] font-normal mb-6 text-white text-balance" data-swiper-parallax="-300">
                Tech Consulting & <br />
              ...
              <div data-swiper-parallax="-100">
                <Link href="/contact-us" className="inline-block px-8 py-3 bg-[#ffb916] border-2 border-[#ffb916] cursor-pointer text-white rounded font-bold transition-all hover:shadow-lg hover:bg-transparent hover:border-[#154EA1] hover:text-[#154EA1]">Get in Touch</Link>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="w-full h-full relative flex items-center">
          ...
          <div className="max-w-[1300px] mx-auto px-6 h-full flex flex-col justify-center relative z-10 pt-24 pb-24 md:pt-32 md:pb-48 w-full">
            <div className="max-w-4xl">
              ...
              <div data-swiper-parallax="-100">
                <Link href="/contact-us" className="inline-block px-8 py-3 bg-[#ffb916] border-2 border-[#ffb916] cursor-pointer text-white rounded font-bold transition-all hover:shadow-lg hover:bg-transparent hover:border-[#154EA1] hover:text-[#154EA1]">Explore</Link>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="w-full h-full relative flex items-center">
          ...
          <div className="max-w-[1300px] mx-auto px-6 h-full flex flex-col justify-center relative z-10 pt-24 pb-24 md:pt-32 md:pb-48 w-full">
            <div className="max-w-4xl">
              ...
              <div data-swiper-parallax="-100">
                <a href="#solutions" className="inline-block px-8 py-3 bg-[#ffb916] border-2 border-[#ffb916] cursor-pointer text-white rounded font-bold transition-all hover:shadow-lg hover:bg-transparent hover:border-[#154EA1] hover:text-[#154EA1]">Discover More</a>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="w-full h-full relative flex items-center">
          ...
          <div className="max-w-[1300px] mx-auto px-6 h-full flex flex-col justify-center relative z-10 pt-24 pb-24 md:pt-32 md:pb-48 w-full">
            <div className="max-w-4xl">
              ...
              <div data-swiper-parallax="-100">
                <a href="#about" className="inline-block px-8 py-3 bg-[#ffb916] border-2 border-[#ffb916] cursor-pointer text-white rounded font-bold transition-all hover:shadow-lg hover:bg-transparent hover:border-[#154EA1] hover:text-[#154EA1]">Our Journey</a>
              </div>
            </div>
          </div>
        </SwiperSlide>
