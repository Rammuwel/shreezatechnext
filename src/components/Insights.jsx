    ...
    <section id="insights" className="py-10 md:py-20 lg:py-24 bg-[#040026] relative">
      <div className="max-w-[1300px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16" data-aos="fade-up">
          <h2 className="text-[28px] md:text-[44px] leading-[36px] md:leading-[52px] font-normal text-white">
            Insights Hub
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {insightsData.map((post, idx) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-[22px] leading-[32px] font-normal text-white mb-6 group-hover:text-[#00A2FF] transition-colors line-clamp-2">
                {post.title}
              </h3>
