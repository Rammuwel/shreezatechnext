  ...
  return (
    <section id="portfolio" className="py-10 md:py-20 lg:py-24 bg-white border-t border-gray-100">
      <div className="max-w-[1300px] mx-auto px-6 text-center">
        <h2 className="text-[22px] md:text-[24px] leading-[1.3] md:text-[40px] md:leading-[56px] font-normal mb-6 text-[#212529]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 items-center justify-items-center">
          {clients.map((client, idx) => (
            <div 
              key={idx} 
              className="w-full h-24 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center grayscale hover:grayscale-0 hover:border-[#ffb916]/30 hover:bg-white hover:shadow-md transition-all duration-300 cursor-pointer"
              data-aos="fade-up"
