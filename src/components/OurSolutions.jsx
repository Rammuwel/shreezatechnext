...
const solutions = [
  ...
  },
  {
    ...
    icon: <Landmark size={32} className="text-[#D4AF37]" />,
      ...
      <div className="max-w-[1300px] mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16" data-aos="fade-up">
          <div className="max-w-2xl">
            <div className="inline-block px-4 py-1.5 rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10 text-[#D4AF37] text-sm font-medium mb-4">Industry Solutions</div>
            <h2 className="text-[36px] md:text-[44px] font-light leading-[1.2] text-white">
              Tailored for <span className="font-semibold text-[#D4AF37]">Your Industry</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {solutions.map((solution, idx) => (
            ...
            >
              {/* Glow Effect */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/10 rounded-bl-full -mr-16 -mt-16 transition-transform duration-500 group-hover:scale-150 z-0 blur-xl"></div>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-[22px] font-medium text-white mb-4 group-hover:text-[#D4AF37] transition-colors">
                  {solution.title}
                </h3>
