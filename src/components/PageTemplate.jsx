...
export default function PageTemplate({ title, breadcrumbText }) {
  return (
    <div className="bg-[#000000] min-h-screen text-white selection:bg-[#ff7f00] selection:text-white">
      ...
      <main className="w-full bg-gray-50 text-black py-32 px-6 lg:px-12 min-h-[50vh] flex flex-col items-center justify-center text-center">
        <div className="max-w-3xl">
          ...
          <h2 className="text-[32px] font-medium text-[#212529] mb-4">Under Construction</h2>
          <p className="text-[18px] text-gray-600 mb-10 leading-relaxed">
          ...
          <Link href="/" className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#D4AF37] border border-[#D4AF37] text-white font-medium hover:bg-transparent hover:text-[#0A3A7A] hover:border-[#0A3A7A] transition-all shadow-sm rounded">
            Return to Home
          </Link>
        </div>
      </main>
